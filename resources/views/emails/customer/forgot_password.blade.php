                ...
                <div class="admin-contact-email" style="background:rgb(243,243,243);padding: 40px; max-width:650px;margin:30px auto;text-align:center;">
                    ...
                    <div class="row align-items-center justify-content-center">
                        <div class="col-lg-12 col-md-12 col-12 align-items-center text-center img-box mb-5">
                            <img src="{{asset('website/img/emails/Forget-PasswordEmail.png')}}" alt="contact-admin">
                        </div>
                        <div class="col-lg-12 col-md-12 col-12 align-items-center text-center">
                            <div class="text-warpper" style="background:white;padding: 40px; max-width:600px; margin:10px auto;">
                                <div class="inner-box">
                                    ...
                                    <h1 class="mb-4" style="text-align:center;">Hello, {{$user->first_name . ' ' .$user->last_name }}!</h1>
                                    <p style="text-align:center;">You are receiving this email because we received a password reset request for your account.</p>
                                    <p style="text-align:center;">Click the link below to complete the process.</p>
                                    <div class="btn-box my-3">
                                        <a href="{{ route('password.reset', $user->remember_token) }}" target="_blank">Reset Password</a>
                                    </div>
                                    
                                </div>
                                <hr>
                                <p style="text-align:center;"><b>If you did not perform this request, you can safely ignore this email.</b></p>
                            </div>
                        </div>
                    </div>
