...
<html lang="en">
    <head>
        ...
        <title>Plan Expire in 5 Days</title>
                ...
                <div class="admin-contact-email" style="background:rgb(243,243,243);padding: 40px; max-width:650px;margin:30px auto;text-align:center;">
                    ...
                    <div class="row align-items-center justify-content-center">
                        <div class="col-lg-12 col-md-12 col-12 align-items-center text-center img-box mb-5">
                            <img src="{{ asset('website/img/emails/PlanExpireEmail5daybefore.png') }}" alt="contact-admin">
                        </div>
                            ...
                            <div class="text-warpper" style="background:white;padding: 40px; max-width:600px; margin:10px auto;text-align:center;">
                                <div class="inner-box">
                                    ...
                                    <div class="btn-box my-3">
                                        <a href="{{ route('customer.subscriptions.index') }}" target="_blank">Renew Plan</a>
                                    </div>
                                </div>
                                <hr>
                                <p class="link-para"><b>If you have any questions or need assistance, please don't hesitate to contact our support team available at <a href="mailto:care@wapost.net">care@wapost.net</a></b></p>
