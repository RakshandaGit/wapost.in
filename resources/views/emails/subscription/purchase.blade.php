                ...
                <div class="admin-contact-email" style="background:rgb(243,243,243);padding: 40px; max-width:650px;margin:30px auto;text-align:center;">
                    ...
                    <div class="row align-items-center justify-content-center">
                        <div class="col-lg-12 col-md-12 col-12 align-items-center text-center img-box mb-5">
                            <img src="{{asset('website/img/emails/PlanSubscriptionEmail.png')}}" alt="contact-admin">
                        </div>
                        <div class="col-lg-12 col-md-12 col-12 align-items-center text-center">
                            <div class="text-warpper" style="background:white;padding: 40px; max-width:600px; margin:10px auto;text-align:center;">
                                <div class="inner-box">
                                    <div class="my-3 text-left">
                                        <a href="{{$url}}"><img src="{{asset('website/img/emails/check-ok.gif') }}" style="width: 100%;max-width: 120px;" alt=""></a>
                                    </div>
                                    <h2 style="color: #00d34d;font-weight: 300;text-align:center;"><span style="font-weight: bold;">Payment Successful!</span></h2>
                                    <p style="text-align:center;">{!! $content !!}</p>
                                    <div class="btn-box my-3 text-left">
                                        <a href="{{$url}}" target="_blank">Invoice</a>
                                    </div>
                                </div>
                                <hr>
                                <p><b>We appreciate your trust in us and look forward to serving you.</b></p>
                            </div>
                        </div>
                    </div>
