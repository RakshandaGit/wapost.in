                ...
                <div class="card p-2">
                    <div class="body">
                        ...
                        @if ($errors->any())
                            ...
                            @endforeach
                        @endif
                        <form id="form" method="POST" action="{{ URL::to('/partner/transactions/assgin-messages') }}"
                            autocomplete="off">
                            @csrf
                                        ...
                                        <div class="form-group form-float mb-2">
                                            ...
                                            <div class="form-line">
                                                <input type="text" id="avaliable_message" class="form-control"
                                                    name="avaliable_message" value="{{ $availableBalance }}" required
                                                    readonly>
                                            </div>
                                        ...
                                        <div class="form-group form-float mb-2">
                                            ...
                                            <div class="form-line">
                                                <input type="number" class="form-control" name="message_qty"
                                                    id="message_qty" value="{{ old('message_qty') }}" required
