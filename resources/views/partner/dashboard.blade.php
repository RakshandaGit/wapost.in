        ...
        <div class="row match-height">
            <div class="col-lg-4 col-sm-6 col-12">
                <div class="card">
                    <div class="card-header">
                        <div>
                            <h2 class="fw-bolder mb-0">{{Auth::user()->id}}</h2>
                            <p class="card-text m-0">{{ __('Your Enterprise Id') }}</p>
                        </div>
                ...
                <div class="card">
                    <div class="card-header">
                        <div>
                            ...
                            <p class="card-text m-0">{{ __('Users') }}</p>
                        </div>
            ...
            <div class="col-lg-4 col-sm-6 col-12">
                <div class="card">
                    <div class="card-header">
                        <div>
                            <h2 class="fw-bolder mb-0">{{ $availableBalance }}</h2>
                            <p class="card-text m-0">{{ __('Available Messages') }}</p>
                        </div>
                        <div class="avatar bg-light-primary p-50 m-0">
                            <div class="avatar-content">
