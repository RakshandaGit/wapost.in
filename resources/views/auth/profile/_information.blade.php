        ...
        <form class="form form-vertical" action="{{ route('user.account.update_information') }}" method="post">
            ...
            <div class="row mt-1">
                ...
                {{-- <div class="col-12 col-sm-6">
                    ...
                    <h5 class="mb-1 mt-2 mt-sm-0"><i data-feather="map-pin"></i>
                        {{ __('locale.labels.billing_address') }}</h5>
                    ...
                    <div class="mb-1">
                        ...
                        <input type="text" id="financial_address"
                            ...
                            value="{{ $user->customer->financial_address }}" name="financial_address">
                    ...
                    <div class="mb-1">
                        ...
                        <input type="text" id="financial_city"
                            ...
                            value="{{ $user->customer->financial_city }}" name="financial_city">
                    ...
                    <div class="mb-1">
                        ...
                        <input type="text" id="financial_postcode"
                            ...
                            value="{{ $user->customer->financial_postcode }}" name="financial_postcode">
                    ...
                    <div class="mb-1">
                        ...
                        <input type="text" id="tax_number"
                            ...
                            value="{{ $user->customer->tax_number }}" name="tax_number">
                        @error('tax_number')
                            <p><small class="text-danger">{{ $message }}</small></p>
                        @enderror
                    </div>
                    ...
                    <h5 class="mb-1 mt-2 mt-sm-0"><i data-feather="alert-circle"></i>
                        {{ __('locale.labels.email_notifications') }}</h5>

                    <div class="mb-1">
                        <div class="form-check form-switch form-check-primary">
                            <label for="login" class="mr-2">{{ __('locale.auth.login') }} <i
                                    data-feather="help-circle" data-bs-toggle='tooltip' data-bs-placement='top'
                                    title='{{ __('locale.customer.every_single_login') }}'></i> </label>
                            <input type="checkbox" name="notifications[login]" value="yes"
                                class="form-check-input" id="login"
                                {{ $user->customer->getNotifications()['login'] == 'yes' ? 'checked' : null }}>
                    ...
                    <div class="mb-1">
                        <div class="form-check form-switch form-check-primary">
                            <label for="sender_id" class="mr-1">{{ __('locale.labels.sender_id') }} <i
                                    data-feather="help-circle" data-bs-toggle='tooltip' data-bs-placement='top'
                                    title='{{ __('locale.customer.sender_id_verification') }}'></i> </label>
                            <input type="checkbox" name="notifications[sender_id]" value="yes"
                                class="form-check-input" id="sender_id"
                                {{ $user->customer->getNotifications()['sender_id'] == 'yes' ? 'checked' : null }}>
                    ...
                    <div class="mb-1">
                        <div class="form-check form-switch form-check-primary">
                            <label for="keyword" class="mr-1">{{ __('locale.labels.keyword') }} <i
                                    data-feather="help-circle" data-bs-toggle='tooltip' data-bs-placement='top'
                                    title='{{ __('locale.customer.purchase_keyword') }}'></i> </label>
                            <input type="checkbox" name="notifications[keyword]" value="yes"
                                class="form-check-input" id="keyword"
                                {{ $user->customer->getNotifications()['keyword'] == 'yes' ? 'checked' : null }}>
                    ...
                    <div class="mb-1">
                        <div class="form-check form-switch form-check-primary">
                            <label for="subscription" class="mr-1">{{ __('locale.menu.Subscriptions') }} <i
                                    data-feather="help-circle" data-bs-toggle='tooltip' data-bs-placement='top'
                                    title='{{ __('locale.customer.successful_subscription') }}'></i> </label>
                            <input type="checkbox" class="form-check-input" name="notifications[subscription]"
                                value="yes" id="subscription"
                                {{ $user->customer->getNotifications()['subscription'] == 'yes' ? 'checked' : null }}>
                    ...
                    <div class="mb-1">
                        <div class="form-check form-switch form-check-primary">
                            <label for="promotion" class="mr-1">{{ __('locale.labels.promotion') }} <i
                                    data-feather="help-circle" data-bs-toggle='tooltip' data-bs-placement='top'
                                    title='{{ __('locale.customer.promotional_newsletter') }}'></i> </label>
                            <input type="checkbox" class="form-check-input" name="notifications[promotion]"
                                value="yes" id="promotion"
                                {{ $user->customer->getNotifications()['promotion'] == 'yes' ? 'checked' : null }}>
                    ...
                    <div class="mb-1">
                        <div class="form-check form-switch form-check-primary">
                            <label for="profile" class="mr-1">{{ __('locale.labels.profile') }} <i
                                    data-feather="help-circle" data-bs-toggle='tooltip' data-bs-placement='top'
                                    title='{{ __('locale.customer.profile_activities') }}'></i> </label>
                            <input type="checkbox" class="form-check-input" id="profile"
                                name="notifications[profile]" value="yes"
                                {{ $user->customer->getNotifications()['profile'] == 'yes' ? 'checked' : null }}>
