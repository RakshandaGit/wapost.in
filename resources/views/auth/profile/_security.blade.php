                    ...
                    <div class="col-12">
                        <div class="mb-1">
                            ...
                            <div class="input-group input-group-merge form-password-toggle">
                                ...
                                <span class="input-group-text cursor-pointer @error('current_password') is-invalid @enderror"><i data-feather="eye"></i></span>
                            </div>
                    ...
                    <div class="col-12">
                        <div class="mb-1">
                            ...
                            <div class="input-group input-group-merge form-password-toggle">
                                ...
                                <span class="input-group-text cursor-pointer @error('password') is-invalid @enderror"><i data-feather="eye"></i></span>
                            </div>
                    ...
                    <div class="col-12">
                        <div class="mb-1">
                            ...
                            <div class="input-group input-group-merge form-password-toggle">
                                ...
                                <span class="input-group-text cursor-pointer @error('password_confirmation') is-invalid @enderror"><i data-feather="eye"></i></span>
                            </div>
