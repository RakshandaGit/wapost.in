                            ...
                            <form class="form form-vertical" action="{{ route('admin.payment-gateways.update', $gateway->uid) }}" method="post">
                                ...
                                <div class="form-body">
                                    <div class="row">
                                        ...
                                        @elseif($gateway->type == PaymentMethods::TYPE_PAYUMONEY || $gateway->type == PaymentMethods::TYPE_PHONEPE)
                                        ...
                                        @elseif($gateway->type == PaymentMethods::TYPE_AZAMPAY)
                                            ...
                                            <div class="col-12">
                                                <div class="mb-1">
                                                    ...
                                                    <input type="text" id="app_name" name="app_name" class="form-control" value="{{ $gateway->getOption('app_name') }}" required>
                                                    @error('app_name')
                                                    <div class="text-danger">
                                                        {{ $message }}
                                                    </div>
                                            ...
                                            <div class="col-12">
                                                <div class="mb-1">
                                                    ...
                                                    <input type="text" id="account_number" name="account_number" class="form-control" value="{{ $gateway->getOption('account_number') }}" required>
                                            ...
                                            <div class="col-12">
                                                <div class="mb-1">
                                                    ...
                                                    <select class="form-select" name="provider" id="provider">
                                                        <option value="Airtel" @if($gateway->getOption('provider') == 'Airtel' ) selected @endif>Airtel</option>
                                                        <option value="Tigo" @if($gateway->getOption('provider') == 'Tigo' ) selected @endif>Tigo</option>
                                                        <option value="Halopesa" @if($gateway->getOption('provider') == 'Halopesa' ) selected @endif>Halopesa</option>
                                                        <option value="Azampesa" @if($gateway->getOption('provider') == 'Azampesa' ) selected @endif>Azampesa</option>
                                                    </select>
                                                    @error('provider')
                                                    <div class="text-danger">
                                                        {{ $message }}
                                        ...
                                        @elseif($gateway->type == PaymentMethods::TYPE_VODACOMMPESA)
                                            ...
                                            <div class="col-12">
                                                <div class="mb-1">
                                                    <label for="apiKey" class="form-label required">{{ __('locale.labels.api_key') }}</label>
                                                    <input type="text" id="apiKey" name="apiKey" class="form-control" value="{{ $gateway->getOption('apiKey') }}" required>
                                                    @error('apiKey')
                                                    <div class="text-danger">
                                                        {{ $message }}
                                                    </div>
                                            ...
                                            <div class="col-12">
                                                <div class="mb-1">
                                                    <label for="publicKey" class="form-label required">{{ __('locale.labels.public_key') }}</label>
                                                    <input type="text" id="publicKey" name="publicKey" class="form-control" value="{{ $gateway->getOption('publicKey') }}" required>
                                                    @error('publicKey')
                                                    <div class="text-danger">
                                                        {{ $message }}
                                                    </div>
                                            ...
                                            <div class="col-12">
                                                <div class="mb-1">
                                                    <label for="serviceProviderCode" class="form-label required">Service Provider Code</label>
                                                    <input type="text" id="serviceProviderCode" name="serviceProviderCode" class="form-control" value="{{ $gateway->getOption('serviceProviderCode') }}" required>
