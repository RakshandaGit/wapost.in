                                ...
                                <p>
                                    @if(function_exists('ini_get'))
                                        @if((int)ini_get('post_max_size') < 120)
                                            Your <code>post_max_size</code> value is: {{ ini_get('post_max_size') }}. Please increase your limit to minimum 120M.<br>
                                        ...
                                        @if((int)ini_get('upload_max_filesize') < 120)
                                            Your <code>upload_max_filesize</code> value is: {{ ini_get('upload_max_filesize') }}. Please increase your limit to minimum 120M.<br>
                                        @else
...
@section('page-script')
    <script src="{{ asset('vendors/js/jquery.form.min.js') }}"></script>
