                ...
                columnDefs: [
                    ...
                    },
                    {
                        ...
                        render: function (data, type, full) {
                            ...
                            if (full['settings'] === 'Whatsender') {
                                returnUrl += '<a href="' + full['devices'] + '" class="text-success">' +
                                    feather.icons['smartphone'].toSvg({class: 'font-medium-4'}) +
                                    '</a>';
                            }
                            return (
                                returnUrl
            ...
            $(".bulk-enable").on('click', function (e) {
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        ...
                        if (sending_server_ids.length > 0) {
