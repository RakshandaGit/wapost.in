            ...
            <div class="form-body">
                <form class="form form-vertical" action="{{ route('admin.plans.update', $plan->uid) }}" method="post">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="mb-1">
                                <label for="addons_price" class="form-label required">Addons Connection {{__('locale.plans.price')}}</label>
                                <input type="text" id="addons_price" class="form-control text-right @error('addons_price') is-invalid @enderror" value="{{ $plan->connection_addons_price }}" name="addons_price" required>
                                @error('addons_price')
                                <p><small class="text-danger">{{ $message }}</small></p>
                                @enderror
                            </div>
