                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12">
                                            <div class="mb-1">
                                                ...
                                                <input type="text" id="addons_price" class="form-control text-right @error('addons_price') is-invalid @enderror" value="{{ old('addons_price') }}" name="addons_price" required>
                                                @error('addons_price')
                                                <p><small class="text-danger">{{ $message }}</small></p>
                                                @enderror
                                            </div>
