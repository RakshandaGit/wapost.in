            ...
            <div class="col-md-8 col-12">
                ...
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <form class="form form-vertical blog-create" action="{{ route('admin.blogs.store') }}"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <div class="mb-1">
                                            <label for="description" class="form-label required">{{ __('Content') }}</label>
                                            <textarea name="description" class="form-control editor description @error('title') is-invalid @enderror"
                                                id="description" value="{{ old('description') }}" required autocomplete="description"></textarea>
                                            @error('description')
                                                <p><small class="text-danger">{{ $message }}</small></p>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-12">
                                        <div class="mb-1">
                                            ...
                                            <input id="meta_keyword" type="text"
                                                ...
                                                value="{{ old('meta_keyword') }}" autocomplete="meta_keyword" />
