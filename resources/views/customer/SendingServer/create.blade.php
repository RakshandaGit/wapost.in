    ...
    <section id="basic-vertical-layouts">
        <div class="row match-height">
            <div class="col-md-6 col-12">
                ...
                <form class="form form-vertical" @if(isset($server['id'])) action="{{ route('customer.sending-servers.update',  $server['uid']) }}" @else action="{{ route('customer.sending-servers.store') }}" @endif method="post">
                    @if(isset($server['id']))
                        {{ method_field('PUT') }}
                    @endif
                    @csrf
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-body">
                                    <div class="row">
                                            ...
                                            <div class="col-12">
                                                <div class="mb-1">
                                                    ...
                                                    <select class="form-select" id="route" name="route">
                                                        ...
                                                        <option value="2" {{ $server['route'] == '2' ? 'selected': null }}> Transactional</option>
                                                        <option value="3" {{ $server['route'] == '3' ? 'selected': null }}> Promo Sender ID</option>
                                                    </select>
                                                </div>
                                            </div>
                                        @endif
                                        ...
                                        @if($server['settings'] ==  SendingServer::TYPE_GUPSHUPIO)
                                            <div class="col-12">
                                                <div class="mb-1">
                                        ...
                                        @if($server['settings'] == 'SendPulse')
                                            ...
                                            <div class="col-12">
                                                <div class="mb-1">
                                                    <label class="form-label required" for="api_secret">Client Secret</label>
                                                    <input type="text" id="api_secret" class="form-control @error('api_secret') is-invalid @enderror" value="{{ $server['api_secret'] }}" name="api_secret" required>
                                                    @error('api_secret')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                        ...
                                        @if($server['settings'] == 'Bandwidth' || $server['settings'] == 'RouteeNet' || $server['settings'] == 'KeccelSMS' || $server['settings'] == 'GlobalSMSCN' || $server['settings'] == 'OnBuka' || $server['settings'] == 'BulkGate')
                                        ...
                                        @if($server['settings'] == 'IconGlobalCoUK')
                                            ...
                                            <div class="col-12">
                                                <div class="mb-1">
                                                    <label class="form-label required" for="application_id">API ID</label>
                                                    <input type="text" id="application_id" class="form-control @error('application_id') is-invalid @enderror" value="{{ $server['application_id'] }}" name="application_id" required>
                                                    @error('application_id')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                        ...
                                        @if($server['settings'] == 'LuxSMS')
                                            ...
                                            <div class="col-12">
                                                <div class="mb-1">
                                                    <label class="form-label required" for="sms_type">Message Type</label>
                                                    <select class="form-select" id="sms_type" name="sms_type">
                                                        <option value="P" {{ $server['sms_type'] == 'P' ? 'selected': null }}> Promotional</option>
                                                        <option value="T" {{ $server['sms_type'] == 'T' ? 'selected': null }}> Transactional</option>
                                                    </select>
                                                </div>
                                            </div>
                                        ...
                                        @if($server['settings'] == 'ClickatellCentral' || $server['settings'] == 'RouteMobile' || $server['settings'] == 'SMSGlobal' || $server['settings'] == 'BulkSMS' ||  $server['settings'] == '1s2u' || $server['settings'] == 'SMPP' || $server['settings'] == 'HutchLk' || $server['settings'] == 'Teletopiasms' || $server['settings'] == 'Solutions4mobiles' || $server['settings'] == 'BulkSMSOnline' || $server['settings'] == 'EasySendSMS' || $server['settings'] == 'AfricasTalking' || $server['settings'] == 'KeccelSMS' || $server['settings'] == 'Text2World' || $server['settings'] == 'LTR' || $server['settings'] == 'Solucoesdigitais' || $server['settings'] == 'BongaTech' || $server['settings'] == 'Ejoin' || $server['settings'] == 'SendSMSGate' || $server['settings'] == 'SMSCarrierEU' || $server['settings'] == 'VisionUp' || $server['settings'] == 'SMSVas' || $server['settings'] == 'CCSSMS' || $server['settings'] == 'Safaricom' || $server['settings'] == SendingServer::TYPE_FACILITAMOVEL || $server['settings'] == SendingServer::TYPE_SMSDELIVERER || $server['settings'] == SendingServer::TYPE_YOSMS|| $server['settings'] == SendingServer::TYPE_ESOLUTIONS || $server['settings'] == SendingServer::TYPE_ESTORESMS || $server['settings'] == SendingServer::TYPE_GOIP || $server['settings'] == SendingServer::TYPE_ADVANCEMSGSYS)
                                        ...
                                        @if($server['settings'] == SendingServer::TYPE_SAFARICOM)
                                            <div class="col-12">
                                                <div class="mb-1">
                                                    <label class="form-label required" for="c1">Campaign User Name</label>
                                                    <input type="text" id="c1" class="form-control @error('c1') is-invalid @enderror" value="{{ $server['c1'] }}" name="c1" required>
                                                    @error('c1')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                            ...
                                            <div class="col-12">
                                                <div class="mb-1">
                                                    <label class="form-label required" for="project_id">Package ID</label>
                                                    <input type="text" id="project_id" class="form-control @error('project_id') is-invalid @enderror" value="{{ $server['project_id'] }}" name="project_id" required>
                                                    @error('project_id')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                        ...
                                        @if($server['settings'] == 'Telnyx' || $server['settings'] == 'TelnyxNumberPool')
                                            <div class="col-12">
                                                <div class="mb-1">
                                                    <label class="form-label required" for="c1">Message Profile ID</label>
                                                    <input type="text" id="c1" class="form-control @error('c1') is-invalid @enderror" value="{{ $server['c1'] }}" name="c1" required>
                                                    @error('c1')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                        ...
                                        @if($server['settings'] == 'MidasAppBr')
                                            ...
                                            <div class="col-12">
                                                <div class="mb-1">
                                                    ...
                                                    <input type="text" id="c2" class="form-control @error('c2') is-invalid @enderror" value="{{ $server['c2'] }}" name="c2">
                                                    @error('c2')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                                    </div>
                                            ...
                                            <div class="col-12">
                                                <div class="mb-1">
                                                    ...
                                                    <input type="text" id="c3" class="form-control @error('c3') is-invalid @enderror" value="{{ $server['c3'] }}" name="c3">
                                                    @error('c3')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                                    </div>
                                            ...
                                            <div class="col-12">
                                                <div class="mb-1">
                                                    ...
                                                    <input type="text" id="c4" class="form-control @error('c4') is-invalid @enderror" value="{{ $server['c4'] }}" name="c4">
                                                    @error('c4')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                                    </div>
                                            ...
                                            <div class="col-12">
                                                <div class="mb-1">
                                                    ...
                                                    <input type="text" id="c5" class="form-control @error('c5') is-invalid @enderror" value="{{ $server['c5'] }}" name="c5">
                                                    @error('c5')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                                    </div>
                                            ...
                                            <div class="col-12">
                                                <div class="mb-1">
                                                    ...
                                                    <input type="text" id="c6" class="form-control @error('c6') is-invalid @enderror" value="{{ $server['c6'] }}" name="c6">
                                                    @error('c6')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                                    </div>
                                            ...
                                            <div class="col-12">
                                                <div class="mb-1">
                                                    ...
                                                    <input type="text" id="c7" class="form-control @error('c7') is-invalid @enderror" value="{{ $server['c7'] }}" name="c7">
                                                    @error('c7')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                                    </div>
...
{{--                                            </div>--}}
                                        ...
                                        @if($server['settings'] == SendingServer::TYPE_SKEBBY)
                                            ...
                                            <div class="col-12">
                                                <div class="mb-1">
                                                    <label class="form-label required" for="access_token">Access Token</label>
                                                    <input type="text" id="access_token"
                                                           class="form-control @error('access_token') is-invalid @enderror"
                                                           value="{{ $server['access_token'] }}" name="access_token" required>
                                                    @error('access_token')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                                    </div>
                                            ...
                                            <div class="col-12">
                                                <div class="mb-1">
                                                    ...
                                                    <select class="form-select" id="c1" name="c1">
                                                        <option value="GP" {{ $server['c1'] == 'GP' ? 'selected': null }}> Classic+</option>
                                                        <option value="TI" {{ $server['c1'] == 'TI' ? 'selected': null }}> Classic</option>
                                                        <option value="SI" {{ $server['c1'] == 'SI' ? 'selected': null }}> Basic</option>
                                                    </select>
                                                </div>
                                                @error('c1')
                                                <div class="invalid-feedback">
                                ...
                                <div class="form-body">
                                    <div class="row">
                                        ...
                                        <div class="d-flex justify-content-start flex-wrap col-12">
                                            ...
                                            @if($server['settings'] == 'Twilio' || $server['settings'] == 'Clickatell_Touch' || $server['settings'] == 'MessageBird' || $server['settings'] == 'WhatsAppChatApi' || $server['settings'] == 'WaApi' || $server['settings'] == 'YooAPI' || $server['settings'] == 'Whatsender' || $server['settings'] == 'Xmsway'  || $server['settings'] == 'MidasAppBr' || $server['type'] == 'whatsapp')
