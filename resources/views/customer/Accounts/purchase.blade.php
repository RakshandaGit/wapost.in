...
@section('content')
    ...
    <section class="modern-horizontal-wizard renew-plan-page">
        <form action="{{ route('customer.subscriptions.purchase', $plan->uid) }}" method="post">
            ...
            <input type="hidden" id="totalFrequencyDuration" name="total_frequency_duration" value="1">
            @if ($errors->any())
                                        ...
                                        <table class="table">
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td> {{ \App\Library\Tool::format_price($plan->price, $plan->currency->format) }}
                                                    </td>
                                                </tr>
                    ...
                    <div class="col-lg-5">
                        ...
                        <div class="addon-total">
                            ...
                            <p class="list-total">
                                ...
                                <span id="totalAddonAmount">Rs.0.00/-</span>
                            </p>

                            <p class="list-total">
                                <span>Previous Plan Adjustment</span>
                                <span
                                    id="totalAddonAmount">Rs.{{ \App\Library\Tool::format_price($totalAadjustedAmount, $plan->currency->format) }}/-</span>
                            </p>
                            <p class="list-total">
                                <span class="text-blue">Total Payable Amount</span>
                                <span
                                    id="totalPayableAmount">Rs.{{ \App\Library\Tool::format_price($plan->price - $totalAadjustedAmount, $plan->currency->format) }}/-</span>
                            </p>
                        </div>
                    </div>
                </div>
    ...
    <script>
        ...
        function onChangeAddonQty(type) {
            ...
            if (addonQty > 0) {
                ...
                var totalAadjustedAmount = parseFloat("{{ $totalAadjustedAmount }}");
                ...
                $("#totalPayableAmount").text(`Rs.${parseFloat(totalPayableAmount - totalAadjustedAmount).toFixed(2)}/-`);
            }
        }
