<div class="row">
    ...
    <div class="col-12">
        <div class="mb-1">
            ...
            {{-- <input type="file" name="file" class="form-control" id="image_file" accept="image/*,video/*" required/> --}}
            <input type="file" name="file" class="form-control" id="image_file" accept="image/*" required />
        </div>
    </div>
