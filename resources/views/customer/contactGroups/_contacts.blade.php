<div id="datatables-basic">
    ...
    <div class="mb-3 mt-2">
        @can('view_contact')
            <div class="btn-group">
                ...
                <div class="dropdown-menu" aria-labelledby="bulk_actions">
                    <a class="dropdown-item bulk-subscribe" href="#"><i data-feather="check"></i> {{ __('locale.labels.activate') }}</a>
                    <a class="dropdown-item bulk-unsubscribe" href="#"><i data-feather="stop-circle"></i> {{ __('locale.labels.deactivate') }}</a>
        ...
        @can('create_contact')
            <div class="btn-group">
                <a href="{{route('customer.contact.create', $contact->uid)}}" class="btn btn-success waves-light waves-effect fw-bold me-1"> {{__('locale.buttons.add_new_contact')}} <i data-feather="plus-circle"></i></a>
            </div>
        @endcan
