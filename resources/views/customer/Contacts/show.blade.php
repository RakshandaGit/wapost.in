                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="mb-1">
                                            ...
                                            {{-- {{dd($data->birth_date)}} --}}
                                            <input type="text" id="birth_datepicker" class="form-control" name="birth_date" autocomplete="off"  value="{{ $data->birth_date ? date('d-m-Y', strtotime($data->birth_date)) : ''}}">
                                            @error('birth_date')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                        ...
                                        <div class="mb-1">
                                            ...
                                            <input type="text" id="anniversary_date" class="form-control" name="anniversary_date" autocomplete="off" value="{{ $data->anniversary_date ? date('d-m-Y', strtotime($data->anniversary_date)) : ''}}">
