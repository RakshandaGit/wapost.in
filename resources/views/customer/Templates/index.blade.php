...
@section('content')
    ...
    <section id="datatables-basic">
        <div class="mb-3 mt-2">
            ...
            @can('sms_template')
                <div class="btn-group">
                    <a href="{{route('customer.templates.create')}}" class="btn btn-success waves-light waves-effect fw-bold mx-1"> {{__('locale.buttons.add_new')}} <i data-feather="plus-circle"></i></a>
                </div>
            @endcan
                    ...
                    <table class="table datatables-basic">
                        ...
                        <tr>
                            ...
                            @if(config('app.trai_dlt'))
                                <th>{{__('locale.labels.approve')}}</th>
                            @endif
...
@section('page-script')
    ...
    <script>
        $(document).ready(function () {
            "use strict"
            let is_dlt = "{{ config('app.trai_dlt') }}";
                ...
                columnDefs: [
                    ...
                    },
                    {
                        ...
                        render: function (data, type, full) {
                            let $return_url = '';
                            if (!full['is_dlt']) {
                                $return_url = '<a href="' + full['edit'] + '" class="text-primary  me-1">' +
