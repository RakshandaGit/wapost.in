                                    ...
                                    <div class="col-12">
                                        <div class="mb-1">
                                            <div class='form-check form-switch form-check-primary form-switch-xl'>
                                                <input type="checkbox" class="form-check-input" name="option_toggle" value="on" id="option_toggle" checked>
                                        ...
                                        <div class="import_file">
                                            ...
                                            <div class="mb-1">
                                                ...
                                                <div class="us-file-zone us-clickable">
                                                    <input type="file" name="import_file" class="us-file upload-file" id="import_file" accept=".csv, application/vnd.openxmlformats-officedocument.spreadsheetml.sheet, application/vnd.ms-excel" required>
