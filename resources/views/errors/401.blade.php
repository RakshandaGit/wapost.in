            ...
            <div class="content-detail">
                <div class="row">
                    <div class="col-lg-6 col-md-6">
                        ...
                        <h1 class="global-title"><span>4</span><span>0</span><span>1</span></h1>
        
                        <h4 class="sub-title">Not Authorized</h4>
        
                        <p class="detail-text">Sorry but, You are is not authorized to access this page.</p> 
                    ...
                    <div class="col-lg-6 col-md-6 d-flex align-items-center">
                        <img src="{{url('/')}}/website/img/404/401error.png" class="shape-02" alt="mountant">
                    </div>
                </div>
            </div>
        </div>
