...
@section('title', __('locale.http.429.title'))
@section('code', '429')
            ...
            <div class="content-detail">
                <div class="row">
                    <div class="col-lg-6 col-md-6">
                        ...
                        <h1 class="global-title"><span>4</span><span>2</span><span>9</span></h1>
                        <h4 class="sub-title">Opps ...</h4>
        
                        <p class="detail-text">Too Many Requests. You've made too many requests recently. Please wait and try your request again later.</p> 
                    ...
                    <div class="col-lg-6 col-md-6 d-flex align-items-center">
                        <img class="img-fluid mt-3" src="{{url('/')}}/website/img/404/requests-error.png" alt="Error page" />
                    </div>
                </div>
            </div>
        </div>
