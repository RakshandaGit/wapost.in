...
return [
    ...
    //Localization for application labels
        'labels'     => [
                ...
                'actions'                               => 'Actions',
                'reason'                                => 'Reason',
                'wa_logout_msg'                         => 'WhatsApp is not login',
                'general'                               => 'General',
                ...
                'credit_per_wa'                         => 'Credit Per WhatsApp',
                'credit_per_sms'                        => 'Credit Per WhatsApp',
                'advanced'                              => 'Advanced',
                'one_time'                              => 'One time',
                'frequency'                             => 'Frequency',
            ...
            /*Whatsender Device*/
                ...
                'whatsapp_connections'        => 'Whatsapp Connections'
    ...
    */
        ...
        'menu' => [
                ...
                "Campaign Builder"   => "Send Campaign",
                "Quick Send"         => "Quick Send",
                "Campaign Details"   => "Campaign Details",
                "Quick Send Details" => "Quick Send Details",
                "Text Message"       => "Text Message",
                "Image Message"      => "Image Message",
                "Video Message"      => "Video Message",
                "Audio Message"      => "Audio Message",
                "Document Message"   => "Document Message",
                "Media URL Message"  => "Media URL Message",
                "Contact Message"    => "Contact Message",
                "Button Message"     => "Button Message",
                "Button & Media Message"=> "Button & Media Message",
                ...
                "partners_inquiry"   => "Partners Inquiry",
                "partners"   => "Partners",
                "users"   => "Users",
                "transactions"   => "Transactions",
                "allocates"   => "Allocates",
        ...
        'plans' => [
                ...
                'wa_sending_credits'                           => 'Whatsapps sending credits',
                ...
                'max_contacts_per_group'                       => 'Max Contacts per Group',
                'media_image_video_audio_messages'             => 'Media (Image/Video/Audio) Messages',
                'file_documnet_messages'                       => 'File/Document Messages',
                ...
                'customer_can_delete_wa_history'               => 'Customer can delete whatsapps history',
        ...
        'blacklist' => [
                ...
                'blacklist_successfully_updated' => 'Blacklist was successfully updated',
        ...
        'customer' => [
                ...
                'old_password_not_matched'         => 'The entered password doesn\'t match with :attribute',
        ...
        'subscription' => [
                ...
                'payment_for_addons'                     => 'Payment for Addons',
        ...
        'permission' => [
            ...
            //customer permission
                ...
                'chat_box'                           => 'Chat Box',
                'invoices'                           => 'Invoices',
                'fetch_whatsapp_group'               => 'Fetch WhatsApp Group',
                'update_whatsapp_group'              => 'Update WhatsApp Group',
        ...
        'contacts'  => [
                ...
                'whatsapp_contact_group_successfully_fetched' => 'WhatsApp contact group is successfully fetched',
                'whatsapp_message_sent_successfully'          => 'WhatsApp message has sent successfully',
                'whatsapp_message_schedule'                   => 'WhatsApp message has schedule successfully',
                'whatsapp_message_not_sent'                   => 'WhatsApp message not sent from WhatsApp Server',
                ...
                'you_have_already_subscribed'                 => 'Number is already present in :contact_group',
    ...
    //campaign translation
        ...
        "description" => [
                'sending_credit' => "The configuration setting below allows you to set a limit on whatsapps sending speed. For example, to limit sending speed to <code>500 whatsapps every 5 minutes </code>, you can set <code> Sending limit = 500, Time value = 5, and Time unit = minute </code> accordingly. Also set <code>amount</code> of <code>several messages</code> with a <code>single HTTP request.</code>",

                'plan_sending_server_intro' => 'Below are sending servers that will be used for this plan. In other words, whatsapps sent out by users who subscribe to this plan will be delivered by these servers',

                'sending_speed' => "The configuration setting below allows you to set a limit on whatsapps sending speed. For example, to limit sending speed to <code>500 whatsapps every 5 minutes </code>, you can set <code> Sending limit = 500, Time value = 5, and Time unit = minute </code> accordingly.</code>",

                'max_process' => "<code>Ultimate whatsapps</code> supports forking <code>multiple processes</code> for sending multiple times faster in terms of whatsapps throughput. However, it will consume multiple times <code>more CPU and memory</code> as a trade-off.",

                'custom_sending_credit' => "The configuration setting below allows you to set a limit on whatsapps sending speed. For example, to limit sending speed to <code>500 whatsapps every 5 minutes </code>, you can set <code> Sending limit = 500, Time value = 5, and Time unit = minute </code> accordingly. If you set <code>WhatsApps Per Single Request</code> grater than <code>1</code> then you must have to select your <code>Delimiter</code> for multiple whatsapps.",

                'cutting_system' => "The configuration setting below allows you to set a limit on whatsapps cutting system. For example, to set number of cutting whatsapps to <code>5 percent whatsapps randomly </code>, you can set <code> Cutting Value= 5, Cutting Unit = Percentage, and Cutting Login = Cutting Random Number </code> accordingly. Example If you want to send <code>100 whatsapps</code> and set cutting value <code>5 percent</code> then <code>95 whatsapps</code> will send, rest <code>5 whatsapps</code> set delivered as status without sending. You can also set <code>specific amount </code> of cutting whatsapps using <code>Digit</code> instead <code>Percentage</code> from <code>Cutting Unit</code> dropdown. Set <code>0</code> for no cutting.",
                ...
                'clickatell' => 'Create a new Clickatell account <a href="https://www.clickatell.com/sign-up/" target="_blank">here</a> , or sign into <a href="https://www.clickatell.com/sign-in/" target="_blank"> an existing Clickatell account</a> After login with Clickatell you will find <code>Create WhatsApps HTTP API</code> button. Then click on <code>Create new integration</code> button. Finally, copy the <code>api key</code> and paste on ',
...
on ',
                ...
                'blacklist'         => 'Paste your <code>blacklist numbers</code> and choose <code>delimiter</code> to seprate numbers',
