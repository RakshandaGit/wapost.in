...
Route::get('partner', 'CustomerController@partner')->name('partner');
Route::post('partnerShow', 'CustomerController@partnerShow')->name('partnerShow');
Route::get('customers/{customer}/approve-transaction', 'CustomerController@approveTransaction')->name('customers.approveTransaction');
Route::post('customers/{customer}/assgin-messages', 'CustomerController@assginMessagesToCustomer')->name('assginMessagesToCustomer');
...
|
*/
Route::get('leads', 'LeadController@index')->name('theme.leads');
// Route::post('leads', 'LeadsCustomizerController@postCustomizer');
...
Route::get('blogs/{blog}/show', 'BlogController@show')->name('blogs.show');
Route::post('blogs/{blog}/active', 'BlogController@activeToggle')->name('blogs.active');
Route::post('blogs/batch_action', 'BlogController@batchAction')->name('blogs.batch_action');
...
Route::get('blog/settings','BlogController@settings')->name('blogs.settings');
...
//authors module
Route::post('author/search', 'AuthorController@search')->name('author.search');
Route::get('authors/{author}/show', 'AuthorController@show')->name('author.show');
Route::post('/authors/destroy-author/{id}','AuthorController@destroyAuthor')->name('author.destroyAuthor');
Route::resource('author', 'AuthorController', [
        'only' => ['index', 'create', 'store', 'update', 'destroy'],
]);
Route::post('authos/batch_action', 'AuthorController@batchAction')->name('author.batch_action');
