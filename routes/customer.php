...
Route::get('contacts/groupMessage', 'ContactsController@groupMessage')->name('contact.group_message');
Route::get('contacts/get-message-field-view/{type}', 'ContactsController@getMessageFieldView')->name('contact.get_message_field_view');
...
Route::any('callback/payherelk/senderid', 'PaymentController@payherelkSenderID')->name('callback.payherelk.senderid');
Route::any('callback/payherelk/numbers', 'PaymentController@payherelkNumbers')->name('callback.payherelk.numbers');
Route::any('callback/payherelk/keywords', 'PaymentController@payherelkKeywords')->name('callback.payherelk.keywords');
Route::any('callback/payherelk/subscriptions', 'PaymentController@payherelkSubscriptions')->name('callback.payherelk.subscriptions');
Route::any('callback/payherelk/top-up', 'PaymentController@payherelkTopUp')->name('callback.payherelk.top_up');
...
Route::get('subscriptions/{subscription}/addons', 'SubscriptionController@addons')->name('subscriptions.addons');
Route::post('subscriptions/{subscription}/addons', 'SubscriptionController@addonsPost');
...
Route::prefix('whatsapp')->name('whatsapp.')->group(function () {
    ...
    Route::get('/quick-send', 'CampaignController@quickSendDash')->name('quick_send');
...
Route::prefix('reports')->name('reports.')->group(function () {
    ...
    Route::get('/quick_send_report_details', 'ReportsController@reports')->name('quick_send_report_details');
    Route::get('/campaign_details', 'ReportsController@reports')->name('campaign_details');
    ...
    Route::get('/campaign/details/{id}', 'ReportsController@campaignDetails')->name('campaignDetails');
    Route::get('/campaign/edit/{schedule_id}', 'CampaignController@editWhatsAppCampaignBuilder')->name('editWhatsAppCampaignBuilder');
    Route::post('/campaign/update/{schedule_id}', 'CampaignController@updateWhatsAppCampaign');

    Route::get('/quick-send/details/{id}', 'ReportsController@quicksendDetails')->name('quicksendDetails');
...
// connection route by Ratan Dahat
Route::get('connection', 'ConnectionController@index')->name('connection');
Route::post('set_instance', 'ConnectionController@setInstanceKey')->name('set_instance');
Route::post('logut_instance', 'ConnectionController@logout')->name('logut_instance');
Route::get('activeDeactiveStatus', 'ConnectionController@activeDeactiveStatus')->name('activeDeactiveStatus');
Route::post('acceptMessageDeclaration', 'ConnectionController@acceptMessageDeclaration')->name('acceptMessageDeclaration');

// fetch whatsapp group 
// Route::get('fetch_group', 'ContactsController@fetchGroup')->name('fetch_group');
Route::post('fetch_group', 'ContactsController@fetchGroup')->name('fetch_group');

// sending normal messages
Route::post('send-message', 'WhatsAppMessageController@sendMessage')->name('sendMessage');

// enduser api docs
Route::get('messaging-api', 'CustomerBaseController@messageApi')->name('messageApi');
Route::get('developer-docs', 'CustomerBaseController@developerAPIDocs')->name('developerDocs');
