...
class Subscription extends Model
{
     ...
     * @return null
     */
    public function getPeriodEndsAt($startDate, $intervalCount = null)
    {
    ...
    { 
        ...
        //######################
        //Register Whatsapp User
        if($type == SubscriptionLog::TYPE_ADMIN_PLAN_ASSIGNED || $type == SubscriptionLog::TYPE_ADMIN_APPROVED || $type == SubscriptionLog::TYPE_PAID)
        {       
            $whatsappData = [
            ...
            Api::whatsappUserRegister($whatsappData);
        }
