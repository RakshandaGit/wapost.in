...
//                }
                ...
                if (str_contains($get_sms_status, '0x9') || str_contains($get_sms_status, '0x6')) {
                    $get_sms_status = 'Delivered';
                }
            } else {
                ...
                switch ($gateway_name) {
                    ...
                    case SendingServer::TYPE_INFOBIP:
                        ...
                        if (isset($sending_server->c1)) {
                            $parameters['messages']['indiaDltContentTemplateId'] = $sending_server->c1;
                        }

                        if (isset($sending_server->c1)) {
                            $parameters['messages']['indiaDltPrincipalEntityId'] = $sending_server->c2;
                        }
...
//                        }
                    ...
                    case SendingServer::TYPE_D7NETWORKS:
                        ...
                        try {
                            ...
                            } elseif (is_array($result) && array_key_exists('detail', $result) && array_key_exists('message', $result['detail'])) {
                                $get_sms_status = $result['detail']['message'];
                            } elseif (is_array($result) && array_key_exists('title', $result)) {
                    ...
                    case SendingServer::TYPE_DIGINTRA:
                        ...
                        try {
                            ...
                            if (curl_errno($ch)) {
                                ...
                                if (is_array($get_response) && array_key_exists('ErrorCode', $get_response) && array_key_exists('ErrorDescription', $get_response)) {
                        ...
                        try {
                            ...
                            if (curl_errno($ch)) {
                                ...
                                switch (trim($response)) {
                                    ...
                                    case '-2916':
                                        $get_sms_status = 'Blocked message content';
                                        break;

                                    case '-2917':
                                        $get_sms_status = 'Blocked sender ID';
                                        break;
                                }
                            }
                            curl_close($ch);
