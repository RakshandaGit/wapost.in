...
class User extends Authenticatable implements MustVerifyEmail
{
    ...
    protected $fillable = [
        ...
        'api_sending_server',
        'is_accept_connection_declaration',
        'is_enterprise'
    ];
    ...
    {
        return $this->hasOne(Connection::class)->orderBy('created_at', 'desc');
    }
    ...
    // write the method for available message mapping with message taransaction
    public function availableMessage()
    {
        return $this->hasOne(MessageTransaction::class)->orderBy('id', 'desc');
    }
}
